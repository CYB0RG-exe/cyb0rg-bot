...
class Window(Frame):
    ...
    def basla(self):
        try:
            ...
            messagebox.showerror("Hata: z", f"Seçilen isimde ekran bulunamadı.\n{e}")
    def durdur(self):
...
root = Tk()
app = Window(root)
root.wm_title("Metin2 Metin Botu | 06.06.2024")
...
me = Label(root, text="Developer: cyb0rg.exe", fg="#6E7371",cursor="hand2",font="Verdana 7 bold")
me.pack(side=BOTTOM)
